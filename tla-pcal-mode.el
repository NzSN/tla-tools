...
(transient-define-prefix tla-pcal-transient ()
  ...
  ["Apalache"
   ("P" "Parse spec" tla--run-apalache-parse)
   ("T" "Typecheck spec" tla--run-apalache-typecheck)
   (tla--apalache-inv-infix)
   (tla--apalache-length-infix)
   (tla--apalache-max-run-infix)
